<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Here's your training schedule overview
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $stats['upcomingClasses'] }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">My Upcoming Classes</h3>
                    <div class="space-y-4">
                        @forelse($myClasses as $class)
                            <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="text-sm text-gray-500 dark:text-gray-400">
                                            {{ $class->description ? Str::limit($class->description, 50) : 'No description' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="text-right">
                                    ...
                                    <div class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ $class->schedule_time->format('g:i A') }} ({{ $class->duration_minutes }} min)
                                    </div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        {{ $class->bookings->count() }}/{{ $class->capacity }} booked
                                    </div>
                                </div>
                            </div>
                        @empty
                            <div class="text-center py-8">
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">You don't have any classes scheduled yet.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="{{ route('classes.create') }}" class="flex items-center p-4 bg-blue-50 dark:bg-blue-900 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-800 transition-colors">
                            ...
                            <span class="text-sm font-medium text-blue-900 dark:text-blue-100">Create Class</span>
                        </a>

                        <a href="{{ route('classes.index') }}" class="flex items-center p-4 bg-green-50 dark:bg-green-900 rounded-lg hover:bg-green-100 dark:hover:bg-green-800 transition-colors">
                            ...
                            <span class="text-sm font-medium text-green-900 dark:text-green-100">View All Classes</span>
                        </a>
